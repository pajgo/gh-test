...
**Definitions**:
 ...
 - **response.common#/definitions/transaction_item**
    ...
    Properties:
     ...
     - **quantity**
        <a name="response.common--/definitions/transaction_item/properties/quantity"/>`{string,number}`<br>
     - **name**
 ...
 - **response.common.sale#/definitions/transaction**
    ...
    Properties:
     ...
     - **related_resources**
        ...
        Each item should be:
        <a name="response.common.sale--/definitions/transaction/properties/related_resources/items"/>`{any}`<br>
